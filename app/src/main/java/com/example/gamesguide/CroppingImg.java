...
import static com.example.gamesguide.DBmain.TABLENAME;
...
import com.example.gamesguide.databinding.ActivityCroppingImgBinding;
...
public class CroppingImg extends AppCompatActivity {
    private ActivityCroppingImgBinding binding;
    DBmain dBmain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCroppingImgBinding.inflate(getLayoutInflater());
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (rec != null) {
                    Toast.makeText(CroppingImg.this, "Data Inserted",
                    ...
                    Toast.makeText(CroppingImg.this, "Something Wrong",
                            Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent( CroppingImg.this,
                        DisplayData.class));
            }
        });
        ...
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(recedit != -1){
                    Toast.makeText(CroppingImg.this, "Update Succesfully",
                            Toast.LENGTH_SHORT).show();
                    ...
                    Intent a = new Intent(CroppingImg.this, DisplayData.class);
                    startActivity(a);
                }
            }
        });
            ...
            case MY_CAMERA_REQUEST_CODE: {
                if (grantResults.length > 0) {
                    ...
                    if (camera_accepted && storage_accepted) {
                        ...
                        Toast.makeText(this, "enable camera and storage permission",
                                Toast.LENGTH_SHORT).show();
                    }
                }
            }
