...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public MyAdapter(Context context, int singledata, ArrayList<Model> modelArrayList,
                     SQLiteDatabase sqLiteDatabase) {
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                            case R.id.edit_menu:
                                ...
                                Intent intent = new Intent(context, CroppingImg.class);
                            ...
                            case R.id.delete_menu:
                                ...
                                long recdelete = sqLiteDatabase.delete(TABLENAME,
                                        "id="+model.getId(),null);
                                if (recdelete != -1){
